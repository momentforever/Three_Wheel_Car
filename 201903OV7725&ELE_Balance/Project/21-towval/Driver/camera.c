...
uint8 imgbuff_process[600];               //定义处理图像用的数组
uint8 img_edg[1200];                           //
...
{
    dma_portx2buff_init(DMA_CH0, (void *)&PTD_B0_IN, imgbuff, PTC13, DMA_BYTE1, CAMERA_DMA_NUM, DADDR_KEEPON);
    ...
    port_init(PTC15, ALT1 | IRQ_FALLING | PULLDOWN | PF);     //场中断，上拉，上降沿触发中断，带滤波
